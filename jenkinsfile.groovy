...
TESTCMD = 'sbt --batch test' //TODO
REGISTRYURL = 'harbor.hydrosphere.io/hydro-serving'
SERVICEIMAGENAME = 'hydro-root-cause'
...
def updateHelmChart(String newVersion){
  dir('helm'){
    ...
    //Change template
    sh script: "sed -i \"s/.*full:.*/  full: $REGISTRYURL\\/$SERVICEIMAGENAME:$newVersion/g\" rootcause/values.yaml", label: "sed $SERVICEIMAGENAME version"
