...
class AnchorExplanation:
    ...
    def precision(self, partial_index: int = None):
        """
    ...
    def coverage(self, partial_index: int = None):
        """
    ...
    def examples(self,
        ...
        Args:
            ...
            where the anchor  makes a different prediction than the original model

            only_same_prediction(bool): if true, will only return examples
            where the anchor makes the same prediction than the original model

            partial_index (int): lets you get the examples from the partial
            anchor until a certain index.
        """
        # TODO: remove mutually exclusive arguments
